---
name: BeUniq Design
description: Rule-based frontend design, taste, motion-craft, landing-copy audit, concrete component/block pattern selection, two-step company-style reference choice, and project-context workflow for reducing generic AI-generated UI patterns without AI APIs. Use when asked to make React, Next.js, Vite, HTML, CSS, SCSS, or Tailwind UI feel less AI-generated, choose concrete UI examples for buttons, fields, cards, modals, header, hero, pricing, how-it-works, text animation, scroll behavior, or company-inspired style references, improve taste, review motion craft, initialize PRODUCT.md/DESIGN.md design context, run a BeUniq AI-slop/design-quality check, or iterate until aiSlop, copySlop, and tasteScore are at or below 20. For UI change, polish, redesign, cleanup, or fix passes, first read existing PRODUCT.md/DESIGN.md, Selected Style Profile, and Company Style Reference; if any is missing or TBD, ask the missing intake/style/company-reference choice and wait before editing or running fixes.
allowed-tools:
  - Read
  - Grep
  - Glob
